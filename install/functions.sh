...
function install_end_message {
	...
	echo -e "$YELLOW  | Version:$GREEN v0.4.7                                                 |				$COL_RESET"
...
function last_words {
	echo "<-------------------------------------|---------------------------------------->"
	echo
	echo -e "$YELLOW Thank you for using the Yiimpool Installer $GREEN v0.4.7!             $COL_RESET"
	echo
	...
	echo "<-------------------------------------|--------------------------------------->"
	echo -e "$YELLOW Thank you for using Yiimp Install Script v0.4.7 fork by Afiniel!      $COL_RESET"
	echo
	echo -e "$YELLOW =>  To run this installer anytime simply type:$GREEN yiimpool         $COL_RESET"
