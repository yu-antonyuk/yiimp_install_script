...
function install_end_message {
	...
	echo -e "$CYAN  --------------------------------------------------------------------------- 	  $COL_RESET"
	echo -e "$RED   Your mysql information (login/Password) is saved in ~/.my.cnf					  $COL_RESET"
	echo -e "$CYAN  ---------------------------------------------------------------------------	  	  $COL_RESET"
	...
	echo -e "$CYAN  --------------------------------------------------------------------------- 	  $COL_RESET"
	echo -e "$CYAN  Please make sure to change your public keys / wallet addresses in, 		      	  $COL_RESET"
